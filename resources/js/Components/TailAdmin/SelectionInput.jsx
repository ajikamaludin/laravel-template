            ...
            <div className="w-full flex flex-col items-center">
                <div className="w-full">
                    <div className="flex flex-col relative">
                            ...
                            <div
                                ...
                                ${
                                    error
                                        ...
                                        : 'bg-transparent flex items-center border rounded-lg border-stroke outline-none dark:border-form-strokedark dark:text-white'
                                }
                                ${disabled ? 'bg-slate-100' : ''}`}
                            >
                                <input
                                    className={`'w-full border-transparent focus:border-none focus:outline-none bg-transparent py-4 pl-6 pr-10 text-black outline-none  dark:text-white focus:ring-transparent focus:shadow-none'}`}
                        ...
                        {isOpen && (
                            <div
                                className="absolute mt-1 shadow-lg bg-gray-2 dark:bg-boxdark dark:text-gray-400 top-100 z-40 w-full lef-0 rounded overflow-y-auto"
